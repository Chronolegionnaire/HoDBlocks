        ...
        public override WorldInteraction[] GetPlacedBlockInteractionHelp(IWorldAccessor world, BlockSelection selection, IPlayer forPlayer)
        {
            if (selection.SelectionBoxIndex == 0)
            {
                return new WorldInteraction[]
                {
                    ...
                    {
                        ActionLangCode = Lang.Get("hodblocks:blockhelp-winch-addremoveitems"),
            ...
            return new WorldInteraction[]
            {
                new WorldInteraction
                {
                    ActionLangCode = Lang.Get("hodblocks:blockhelp-winch-lower"),
                    MouseButton = EnumMouseButton.Right,
                ...
                new WorldInteraction
                {
                    ActionLangCode = Lang.Get("hodblocks:blockhelp-winch-raise"),
                    MouseButton = EnumMouseButton.Right,
                    HotKeyCode = ("sneak"),
                    ShouldApply = (wi, bs, es) =>
                    {
