...
namespace HoDBlocks.Keg
{
    public class BlockTun : BlockLiquidContainerBase
    {
        ...
        {
            tunCapacityLitres = HoDBlocksModSystem.LoadedConfig.TunCapacityLitres;
            tunDropWithLiquid = HoDBlocksModSystem.LoadedConfig.TunDropWithLiquid;
        }
        ...
        private void RegisterConfigUpdateListener(ICoreAPI api)
        {
            ...
            {
                float newTunCapacity = HoDBlocksModSystem.LoadedConfig.TunCapacityLitres;
