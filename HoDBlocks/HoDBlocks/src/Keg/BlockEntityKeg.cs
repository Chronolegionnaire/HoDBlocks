...
namespace HoDBlocks.Keg
{
    public class BlockEntityKeg : BlockEntityLiquidContainer
    {
        ...
        private float spoilRateTapped = HoDBlocksModSystem.LoadedConfig.SpoilRateTapped;
        private float spoilRateUntapped = HoDBlocksModSystem.LoadedConfig.SpoilRateUntapped;
